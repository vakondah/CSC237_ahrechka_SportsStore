...
namespace CSC237_ahrechka_SportsStore.Migrations
{
    ...
    [Migration("20200410175642_Registration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CSC237_ahrechka_SportsStore.Models.Country", b =>
                {
            ...
            modelBuilder.Entity("CSC237_ahrechka_SportsStore.Models.Customer", b =>
                {
            ...
            modelBuilder.Entity("CSC237_ahrechka_SportsStore.Models.Incident", b =>
                {
            ...
            modelBuilder.Entity("CSC237_ahrechka_SportsStore.Models.Product", b =>
                {
                    b.Property<int>("ProductID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CSC237_ahrechka_SportsStore.Models.Registration", b =>
                {
                    b.Property<int>("CustomerID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CSC237_ahrechka_SportsStore.Models.Technician", b =>
                {
                    b.Property<int>("TechnicianID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CSC237_ahrechka_SportsStore.Models.Customer", b =>
                {
                    b.HasOne("CSC237_ahrechka_SportsStore.Models.Country", "Country")
                        .WithMany()
            ...
            modelBuilder.Entity("CSC237_ahrechka_SportsStore.Models.Incident", b =>
                {
                    b.HasOne("CSC237_ahrechka_SportsStore.Models.Customer", "Customer")
                        .WithMany()
                        .HasForeignKey("CustomerID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CSC237_ahrechka_SportsStore.Models.Product", "Product")
                        .WithMany()
                        .HasForeignKey("ProductID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CSC237_ahrechka_SportsStore.Models.Technician", "Technician")
                        .WithMany()
